...
class DeliveryBlock
{
    ...
    public function _register()
    {
        acf_register_block_type(
            array(
                ...
                'description'       => 'Блок с описанием способов доставки и оплаты заказа',
                // 'post_types'        => array(),
    ...
    public function _enqueue_assets()
    {
        ...
        wp_enqueue_style('theme/delivery-block',GSE()::theme_uri().$path.'/block.css',array(),2);
        wp_enqueue_script('theme/delivery-block',GSE()::theme_uri().$path.'/block.js',array(),2);
        return;
    }
