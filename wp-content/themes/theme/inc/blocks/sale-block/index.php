...
class SaleBlock
{
    ...
    public function _register()
    {
        acf_register_block_type(
            array(
                'name'              => 'sale-block',
                'title'             => 'Блок: Распродажа',
                'description'       => 'Блок с товарами со скидкой',
                // 'post_types'        => array(),
    ...
    public function _enqueue_assets()
    {
        ...
        wp_enqueue_style('theme/sale-block',GSE()::theme_uri().$path.'/block.css',array(),2);
        wp_enqueue_script('theme/sale-block',GSE()::theme_uri().$path.'/block.js',array(),2);
        return;
    }
