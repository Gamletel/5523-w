...
class PopularBlock
{
    ...
    public function _register()
    {
        acf_register_block_type(
            array(
                'name'              => 'popular-block',
                'title'             => 'Блок: Популярные товары',
                'description'       => 'Блок с самыми популярными товарами',
                // 'post_types'        => array(),
    ...
    public function _enqueue_assets()
    {
        ...
        wp_enqueue_style('theme/popular-block',GSE()::theme_uri().$path.'/block.css',array(),2);
        wp_enqueue_script('theme/popular-block',GSE()::theme_uri().$path.'/block.js',array(),2);
        return;
    }
