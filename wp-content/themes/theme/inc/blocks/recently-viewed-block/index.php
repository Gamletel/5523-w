...
class RecentlyViewedBlock
{
    ...
    public function _register()
    {
        acf_register_block_type(
            array(
                ...
                'title'             => 'Блок: Просмотренные ранее товары',
                'description'       => 'Блок с ранее просмотренными товарами',
                // 'post_types'        => array(),
    ...
    public function _enqueue_assets()
    {
        ...
        wp_enqueue_style('theme/recently-viewed-block',GSE()::theme_uri().$path.'/block.css',array(),2);
        wp_enqueue_script('theme/recently-viewed-block',GSE()::theme_uri().$path.'/block.js',array(),2);
        return;
    }
...
return new RecentlyViewedBlock();
?>